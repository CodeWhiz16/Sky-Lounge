...
//   // Static card as fallback
//   const staticEvent = {
//     _id: 'static1',
//     dayDisplay: 'OCT 27, 2025',
//     artist: 'EMO NITE',
//     description: 'Experience the ultimate nightlife with EMO NITE performing the GRAVE RAVE SET.',
//     imageUrl: '../assets/event/EMONITE.png'
//   };
...
//   // If no events fetched, use the static card
//   const displayEvents = eventsData.length > 0 ? eventsData : [staticEvent];
...
//             const fullImageUrl = event.imageUrl.startsWith('http') ? event.imageUrl : event.imageUrl;
//             return (
//               <Col lg={10} key={event._id} className="mb-5">
//                 <div className="event-card">
//                   <img src={fullImageUrl} alt={event.artist} className="event-background-image" />
